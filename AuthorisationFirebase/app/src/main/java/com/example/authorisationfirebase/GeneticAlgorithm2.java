...
public class GeneticAlgorithm2 {
     ...
     */
    public Population2 initPopulation(int chromosomeLength){
        // Initialize population
        Population2 population = new Population2(this.populationSize, chromosomeLength);
        return population;
    }
     ...
     */
    public double calcFitness(Individual2 individual, City cities[]){
        // Get fitness
        Route2 route = new Route2(individual, cities);
     ...
     */
    public void evalPopulation(Population2 population, City cities[]){
    ...
    public Population2 crossoverPopulation(Population2 population){
        ...
        for (int populationIndex = 0; populationIndex < population.size(); populationIndex++) {
            ...
            if (this.crossoverRate > Math.random() && populationIndex >= this.elitismCount) {
                ...
                Individual2 parent2 = this.selectParent(population);

                // Create blank offspring chromosome
                int offspringChromosome[] = new int[parent1.getChromosomeLength()];
                Arrays.fill(offspringChromosome, -1);
                Individual2 offspring = new Individual2(offspringChromosome);
    ...
    public Population2 mutatePopulation(Population2 population){
        ...
        // Loop over current population by fitness
        for (int populationIndex = 0; populationIndex < population.size(); populationIndex++) {
            Individual2 individual = population.getFittest(populationIndex);
